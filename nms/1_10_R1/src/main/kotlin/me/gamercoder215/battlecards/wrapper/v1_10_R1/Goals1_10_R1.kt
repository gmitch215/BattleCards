...
class CardOwnerHurtTargetGoal1_10_R1(
    ...
    private var lastHurt: EntityLiving? = nms.bL()

    override fun a(): Boolean {
        lastHurt = nms.bL()
        return timestamp != nms.bM() && a(lastHurt, true)
    }
...
class CardOwnerHurtByTargetGoal1_10_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtTargetGoal1_10_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtByTargetGoal1_10_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardNearestAttackableTargetGoal1_10_R1(entity: EntityCreature, private val card: IBattleCard<*>) : PathfinderGoalTarget(entity, false, true) {
    ...
    fun findTarget() {
        this.target = mob.world.a(EntityLiving::class.java, mob.boundingBox.grow(i(), i(), i()))
            .filterNotNull()
            .filter {

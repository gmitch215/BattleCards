...
class CardOwnerHurtTargetGoal1_16_R2(
...
class CardOwnerHurtByTargetGoal1_16_R2(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardNearestAttackableTargetGoal1_16_R2(entity: EntityCreature, private val card: IBattleCard<*>) : PathfinderGoalTarget(entity, false, true) {

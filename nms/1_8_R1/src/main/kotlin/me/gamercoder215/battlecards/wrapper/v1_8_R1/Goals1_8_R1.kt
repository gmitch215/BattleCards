...
class FollowCardOwner1_8_R1(
    ...
    override fun e() {
        creature.controllerLook.a(player, 10.0F, creature.bP().toFloat())
...
class CardOwnerHurtTargetGoal1_8_R1(
    ...
    private var lastHurt: EntityLiving? = nms.be()

    override fun a(): Boolean {
        lastHurt = nms.be()
        return timestamp != nms.bd() && a(lastHurt, true)
    }
...
class CardOwnerHurtByTargetGoal1_8_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
    ...
    override fun a(): Boolean {
        ...
        return timestamp != nms.bd() && a(lastHurtBy, true)
    }
...
internal class CardMasterHurtTargetGoal1_8_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtByTargetGoal1_8_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardNearestAttackableTargetGoal1_8_R1(entity: EntityCreature, private val card: IBattleCard<*>) : PathfinderGoalTarget(entity, false, true) {

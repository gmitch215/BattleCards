...
class CardOwnerHurtTargetGoal1_9_R1(
    ...
    private var lastHurt: EntityLiving? = nms.bI()

    override fun a(): Boolean {
        lastHurt = nms.bI()
        return timestamp != nms.bJ() && a(lastHurt, true)
    }
...
class CardOwnerHurtByTargetGoal1_9_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtTargetGoal1_9_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtByTargetGoal1_9_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardNearestAttackableTargetGoal1_9_R1(entity: EntityCreature, private val card: IBattleCard<*>) : PathfinderGoalTarget(entity, false, true) {

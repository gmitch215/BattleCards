...
internal class Wrapper1_16_R1 : Wrapper {

    private fun <T> registry(k: ResourceKey<IRegistry<T>>): RegistryMaterials<T> {
        return (Bukkit.getServer() as CraftServer).server.f.a(k).orElseThrow(::IllegalArgumentException) as RegistryMaterials<T>
    }
    ...
    override fun loadProperties(en: Creature, card: IBattleCard<*>) {
        ...
        nms.goalSelector.a(2, FollowCardOwner1_16_R1(nms, card))

        nms.targetSelector.a(1, CardOwnerHurtByTargetGoal1_16_R1(nms, card))
        nms.targetSelector.a(2, CardOwnerHurtTargetGoal1_16_R1(nms, card))
        nms.targetSelector.a(3, PathfinderGoalHurtByTarget(nms))
        if (BattleConfig.config.isAggressive)
            nms.targetSelector.a(4, CardNearestAttackableTargetGoal1_16_R1(nms, card))
    ...
    override fun <T : Creature> spawnMinion(clazz: Class<T>, ownerCard: IBattleCard<*>): T {
        ...
        removeGoals(nms.goalSelector, nms.targetSelector)
        nms.goalSelector.a(2, FollowCardOwner1_16_R1(nms, ownerCard))

        nms.targetSelector.a(1, CardMasterHurtByTargetGoal1_16_R1(nms, ownerCard))
        nms.targetSelector.a(2, CardMasterHurtTargetGoal1_16_R1(nms, ownerCard))
        nms.targetSelector.a(3, CardOwnerHurtByTargetGoal1_16_R1(nms, ownerCard))
        nms.targetSelector.a(4, CardOwnerHurtTargetGoal1_16_R1(nms, ownerCard))
    ...
    override fun addFollowGoal(entity: LivingEntity, ownerCard: IBattleCard<*>) {
        ...
        entity.handle.goalSelector.a(2, FollowCardOwner1_16_R1(entity.handle, ownerCard))
    }
    ...
    override fun createInventory(id: String, name: String, size: Int): BattleInventory {
        return BattleInventory1_16_R1(id, name, size)
    }
    ...
    override fun getYBodyRot(entity: LivingEntity): Float = (entity as CraftLivingEntity).handle.aH
    ...
    override fun addPacketInjector(p: Player) {
        ...
        ch.pipeline().addAfter("decoder", PACKET_INJECTOR_ID, PacketHandler1_16_R1(p))

        PacketHandler1_16_R1.PACKET_HANDLERS[p.uniqueId] = handler@{ packet ->

...
class FollowCardOwner1_16_R1(
    ...
    override fun e() {
        creature.controllerLook.a(player, 10.0F, creature.eo().toFloat())
...
class CardOwnerHurtTargetGoal1_16_R1(
    ...
    private var lastHurt: EntityLiving? = nms.da()
...
class CardOwnerHurtByTargetGoal1_16_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtTargetGoal1_16_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtByTargetGoal1_16_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardNearestAttackableTargetGoal1_16_R1(entity: EntityCreature, private val card: IBattleCard<*>) : PathfinderGoalTarget(entity, false, true) {

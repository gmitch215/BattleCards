...
class FollowCardOwner1_15_R1(
    ...
    override fun e() {
        creature.controllerLook.a(player, 10.0F, creature.dU().toFloat())
...
class CardOwnerHurtTargetGoal1_15_R1(
    ...
    private var lastHurt: EntityLiving? = nms.cJ()

    override fun a(): Boolean {
        lastHurt = nms.cJ()
        return timestamp != nms.cK() && a(lastHurt, PathfinderTargetCondition.a)
    }
...
class CardOwnerHurtByTargetGoal1_15_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtTargetGoal1_15_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtByTargetGoal1_15_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardNearestAttackableTargetGoal1_15_R1(entity: EntityCreature, private val card: IBattleCard<*>) : PathfinderGoalTarget(entity, false, true) {

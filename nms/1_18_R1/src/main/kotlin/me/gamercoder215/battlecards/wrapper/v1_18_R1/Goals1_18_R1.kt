...
class CardOwnerHurtTargetGoal1_18_R1(
...
class CardOwnerHurtByTargetGoal1_18_R1(
    private val creature: PathfinderMob,
    card: IBattleCard<*>
) : TargetGoal(creature, true, true) {
...
internal class CardMasterHurtTargetGoal1_18_R1(
    private val creature: PathfinderMob,
    card: IBattleCard<*>
) : TargetGoal(creature, true, true) {
...
internal class CardMasterHurtByTargetGoal1_18_R1(
    private val creature: PathfinderMob,
    card: IBattleCard<*>
) : TargetGoal(creature, true, true) {

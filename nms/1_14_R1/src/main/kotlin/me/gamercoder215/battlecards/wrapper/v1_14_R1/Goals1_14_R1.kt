...
internal class CardNearestAttackableTargetGoal1_14_R1(entity: EntityCreature, private val card: IBattleCard<*>) : PathfinderGoalTarget(entity, false, true) {
    ...
    fun findTarget() {
        this.target = mob.world.a(
            ...
            targetConditions,
            mob,
            mob.locX, mob.locY + mob.headHeight, mob.locZ
        )
    }

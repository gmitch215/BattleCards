...
class CardOwnerHurtTargetGoal1_13_R1(
...
class CardOwnerHurtByTargetGoal1_13_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtTargetGoal1_13_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtByTargetGoal1_13_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {

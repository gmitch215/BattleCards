...
class CardOwnerHurtTargetGoal1_11_R1(
    ...
    private var lastHurt: EntityLiving? = nms.bM()

    override fun a(): Boolean {
        lastHurt = nms.bM()
        return timestamp != nms.bN() && a(lastHurt, true)
    }
...
class CardOwnerHurtByTargetGoal1_11_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtTargetGoal1_11_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardMasterHurtByTargetGoal1_11_R1(
    private val creature: EntityCreature,
    card: IBattleCard<*>
) : PathfinderGoalTarget(creature, true, true) {
...
internal class CardNearestAttackableTargetGoal1_11_R1(entity: EntityCreature, private val card: IBattleCard<*>) : PathfinderGoalTarget(entity, false, true) {

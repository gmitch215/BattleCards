...
@AttributesModifier(CardAttribute.MAX_HEALTH, CardOperation.ADD, 0.4)
@AttributesModifier(CardAttribute.ATTACK_DAMAGE, CardOperation.ADD, 0.62)
@AttributesModifier(CardAttribute.DEFENSE, CardOperation.ADD, 0.185)
